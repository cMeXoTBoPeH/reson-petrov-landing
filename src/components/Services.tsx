...
const Services: React.FC = () => {
  const services = [
    {
      title: 'Внедряване',
      description: 'Пълно внедряване на международни стандарти и управленски системи според вашите нужди и изисквания.',
      features: [
    ...
    {
      title: 'Обучения',
      description: 'Специализирани обучения на вашия екип за ефективно управление на системите.',
      features: [
        'Обучения за международни стандарти',
        'Обучения на вътрешни одитори',
    ...
    {
      title: 'Подготовка за сертификация',
      description: 'Професионална подготовка на фирми за успешна сертификация.',
      features: [
      ...
      <div className="container-max">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Предлагаме цялостни решения за внедряване и поддържане на управленски системи 
            в различни сфери на икономиката.
          </p>
        </div>
